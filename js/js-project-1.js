document.getElementById('hypotenuseSubmitButton').onclick = function() {
    ...
    document.getElementById("right-triangleSideCLabel").innerHTML = "Side C (Hypotenuse): " + rightTriangleSideC;
    document.getElementById("right-triangleAreaLabel").innerHTML = "Area: " + rightTriangleArea;
}
